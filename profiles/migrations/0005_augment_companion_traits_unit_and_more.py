...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("profiles", "0004_alter_summonermatchesbypuuid_summoner_puuid_and_more"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="profiles.summonermatchesbypuuid",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="participants", to="profiles.augment"
                    ),
                ),
                (
                    "companion",
                ...
                (
                    "traits",
                    models.ManyToManyField(
                        related_name="participants", to="profiles.traits"
                    ),
                ),
                (
                    "units",
                    models.ManyToManyField(
                        related_name="participants", to="profiles.unit"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        primary_key=True,
                        related_name="summoner_match",
                        serialize=False,
                        to="profiles.metadata",
                    ),
                ),
                (
                    "info",
